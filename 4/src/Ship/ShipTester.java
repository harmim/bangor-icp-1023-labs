...
public class ShipTester
{
	...
	{
		System.out.println("New CruiseShip CruiseShip1 built in 2010 with max 100 passangers");
		...
		System.out.println("Maximum number of Passangers: " + cruiseShip.getMaxNumberOfPassengers());
